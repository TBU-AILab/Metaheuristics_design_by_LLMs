...
class Algorithm():
    def __init__(self, func, dim, bounds, max_evals, params=None):
        if params is None:
            self.params = {
                ...
                'elite_size': 5,
                'elite_influence': 0.1,
                'hybridization_factor': 0.5,  # New parameter for hybridization
                'hybridization_probability': 0.3  # New parameter for hybridization probability
            }
        else:
            self.params = params
        self.func = func
    ...
    def hybridization(self, individual, best, factor):
        # Hybridize the individual with the best one based on a factor
