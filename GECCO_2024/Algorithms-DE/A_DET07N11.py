    ...
    def run(self):
        ...
        while self.evals < self.max_evals:
            ...
            for i in range(pop_size):
                ...
                F = self.params['F_base'] if not self.params['exploration_phase'] else np.random.rand()
                Cr = self.params['CR_base'] if not self.params['exploration_phase'] else np.random.rand()
